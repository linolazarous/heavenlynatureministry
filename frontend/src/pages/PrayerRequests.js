    ...
    <div className="min-h-screen">
      <section className="bg-gradient-to-br from-primary/10 to-accent/10 py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="font-heading text-5xl lg:text-6xl font-bold mb-6 text-primary">Prayer Requests</h1>
      ...
      <section className="section-padding bg-background">
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <Card className="shadow-lg" data-testid="prayer-form-card">
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <Button type="submit" className="w-full" disabled={submitting} data-testid="prayer-submit-button">
            ...
            <div>
              <h2 className="font-heading text-3xl font-bold text-primary mb-6">Recent Prayer Requests</h2>
              {loading ? (
                  ...
                  {prayers.slice(0, 5).map((prayer) => (
                    <Card key={prayer.id} className="shadow-sm">
                      <CardContent className="pt-6">
                        ...
                        {prayer.testimony && (
                          <p className="text-sm text-accent mt-2 italic">Testimony: {prayer.testimony}</p>
                        )}
                      </CardContent>
                    </Card>
                  ))}
